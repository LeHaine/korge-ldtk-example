...
inline fun Container.ldtkIntGridAutoLayer(
    ...
    tileset: TileSet,
    callback: LDtkIntGridAutoLayerView.() -> Unit = {}
) =
    LDtkIntGridAutoLayerView(layer, tileset).addTo(this, callback)

class LDtkIntGridAutoLayerView(val layer: LayerIntGridAutoLayer, val tileset: TileSet) : View() {
    ...
    private fun LayerIntGridAutoLayer.getTileAt(cx: Int, cy: Int): LayerAutoLayer.AutoTile? {
